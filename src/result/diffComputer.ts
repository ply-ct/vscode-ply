...
import { IDiffChange, ISequence, LcsDiff, IDiffResult } from './diff';
 ...
 */
function firstNonWhitespaceIndex(str: string): number {
...
function lastNonWhitespaceIndex(str: string, startIndex: number = str.length - 1): number {
